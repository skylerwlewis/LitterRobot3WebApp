...
const RobotDetailsView = () => {
  ...
  const rows = robot ? [
    ...
    createData('Is Drawer Full Indicator Triggered?', robot.isDFITriggered === "1" ? 'Yes' : 'No'),
    createData(`Is "${statusMap['DF1']}" Triggered?`, robot.isDf1Triggered === "1" ? 'Yes' : 'No'),
    createData(`Is "${statusMap['DF2']}" Triggered?`, robot.isDf2Triggered === "1" ? 'Yes' : 'No'),
    createData(`Is "${statusMap['DFS']}" Triggered?`, robot.isDfsTriggered === "1" ? 'Yes' : 'No'),
    ...
    createData('Previous Drawer Full Indicator Triggered?', robot.previousDFITriggered === "1" ? 'Yes' : 'No'),
    createData('Drawer Full Indicator Cycle Count', robot.DFICycleCount),
